...
const Purchases = () => {
  ...
  return (
    <div className="purchases-container">
      ...
      <h2 className="purchases-title">Record a New Purchase</h2>
      <form className="purchase-form" onSubmit={handleSubmit}>
        <input name="name" value={formData.name} onChange={handleChange} placeholder="Asset Name" required />
        ...
        <input name="quantity" value={formData.quantity} onChange={handleChange} placeholder="Quantity" type="number" required />
